...
export const AppState = reactive({
  ...
  automaticUpgrades: [
    new Upgrade({id: '1b', isAuto: true ,name: 'Rover', price: 50, quantity: 0, multiplier: 1}),
    new Upgrade({id: '2b', isAuto: true ,name: 'Rocket', price: 80, quantity: 0, multiplier: 1}),
    new Upgrade({id: '3b', isAuto: true ,name: 'Space station', price: 100, quantity: 0, multiplier: 1}),
  ]
})
